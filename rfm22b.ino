...
void rx_reset(void)
{
  _spi_write(0x07, RF22B_PWRSTATE_READY);     _spi_write(0x07, RF22B_PWRSTATE_READY);
  _spi_write(0x7e, 36);     _spi_write(0x7e, 36);
  _spi_write(0x08, 0x03);     _spi_write(0x08, 0x03);
  _spi_write(0x08, 0x00);     _spi_write(0x08, 0x00);
  _spi_write(0x07, RF22B_PWRSTATE_RX);      _spi_write(0x07, RF22B_PWRSTATE_RX);
  _spi_write(0x3e, RF_PACK_SIZE);
  _spi_write(0x05, RF22B_Rx_packet_received_interrupt);     _spi_write(0x05, RF22B_Rx_packet_received_interrupt);
  ItStatus1 = _spi_read(0x03);      ItStatus1 = _spi_read(0x03);
  ItStatus2 = _spi_read(0x04);      ItStatus2 = _spi_read(0x04);
}
